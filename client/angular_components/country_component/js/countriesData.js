...
var getpopulationdata = function(data) {
 if (data.length >= 1) populationData = data[1];
}

var getgdpgrowthdata = function(data) {
 if (data.length >= 1) gdpgrowthdata = data[1];
}
